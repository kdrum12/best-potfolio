...
if (hours < 12) greetingText = "Good Morning, I am Oche Godwin Victor";
else if (hours < 18) greetingText = "Good Afternoon, I am Oche Godwin Victor";
else greetingText = "Good Evening, I am Oche Godwin Victor";
...
if (codeBackground) {
  ...
  function generateCodeLines() {
    let lines = "";
    for (let i = 0; i < 40; i++) {
      lines += snippets[Math.floor(Math.random()*snippets.length)] + "\n";
    }
